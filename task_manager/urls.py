...
urlpatterns = [
    ...
    path(
        "teams/<int:pk>/update/",
        views.TeamUpdateView.as_view(), name="team_update"
    ),
    path(
        "teams/<int:pk>/delete/",
        views.TeamDeleteView.as_view(), name="team_delete"
    ),
    path("workers/",
    ...
    path(
        "tasks/<int:task_id>/add_worker/",
        views.AddWorkerToTaskView.as_view(),
